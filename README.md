...
If the machine has multiple NICs, you can run `ip -br link show` to check the interface name that is DOWN, then run `ethtool -i <ifname>` to get its corresponding PCI address.
