...
class RestoreRegistersFromContext(gdb.Command):
    ...
    def __init__(self):
        super(RestoreRegistersFromContext, self).__init__("restore-registers", gdb.COMMAND_USER)
...
class RestoreBlockedThread(gdb.Command):
    ...
    def __init__(self):
        super(RestoreBlockedThread, self).__init__("restore-thread", gdb.COMMAND_USER)
